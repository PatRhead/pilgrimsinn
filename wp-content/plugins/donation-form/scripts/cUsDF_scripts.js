...
cUsDF_myjq(document).ready(function($) {
    ...
    try {
        ...
        //LOADING UI BOX
        cUsDF_myjq(".cUsDF_preloadbox").delay(1500).fadeOut();
    ...
    try {
        cUsDF_myjq('#cUsDF_CreateCustomer').click(function() {
            ...
            var cUsDF_phone = cUsDF_myjq('#cUsDF_phone').val();
            ...
            if (!cUsDF_first_name.length) {
                ...
                postData = {action: 'cUsDF_verifyCustomerEmail', fName: str_clean(cUsDF_first_name), lName: str_clean(cUsDF_last_name), Email: cUsDF_email, Phone: cUsDF_phone, credential: cUsDF_pass, website: cUsDF_web};
                    ...
                    success: function(data) {
                        ...
                        switch (data) {
                            case '1':
                                ...
                                cUsDF_myjq('.notice').html(message).show().delay(4000).fadeOut(2000);
                                // location.reload();
                                setTimeout(function() {
    ...
    try {
        cUsDF_myjq('.btn-skip').click(function() {
                    ...
                    success: function(data) {
                        ...
                        switch (data) {
                            case '1':
                                ...
                                cUsDF_myjq('.notice').html(message).show().delay(1900).fadeOut(800);
    ...
    try {
        cUsDF_myjq('#cUsDF_UpdateTemplates').click(function() {
    ...
    try {
        cUsDF_myjq('.load_def_formkey').click(function() { //loading default template

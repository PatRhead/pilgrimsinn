...
if (!function_exists('cUsDF_menu_render')) {
    ...
    function cUsDF_menu_render() {
        ...
        // print_r( $aryUserCredentials ); exit;
        ...
        /*echo $DF_API_Account . "<br />"; //exit;
        echo $DF_API_Key . "<br />";*/
        
        //echo $form_id . '<br />';

        //print_r( get_option('cUsDF_HOME_settings') );
         
        if(!strlen($form_key)) $form_key = $old_options['form_key'];
        if(!strlen($cus_donation_version)) $cus_donation_version = $old_options['cus_donation_version'];
        ...
        if (!is_array($options)) {
            ...
            //$createdonationform = str_replace(" \" ", "", $createdonationform);
            //echo( $createdonationform );
        ?>
            ...
            <div class="cUsDF_formset">
                <div id="cUsDF_tabs">
                    ...
                    <?php }else{
                        ...
                        // print_r($cUsDF_API_getFormKeys); 
						/*echo("<br /><br />");
						echo($default_deep_link);*/
                                                                    ...
                                                                    case 'success':
                                                                        foreach ($cUs_json->data as $oForms => $oForm) {
                                                                            ...
                                                                            <span class="<?php echo ( ( strlen($home_form_key)  && $home_form_key == $oForm->form_key) || $form_key == $oForm->form_key )?'default':'tpl'?> item template-home" rel="<?php echo $oForm->form_key ?>">
                                                                                <img class="tab tab-home" src="https://test.contactus.com
/popup/tpl/<?php echo $oForm->template_desktop_tab ?>/scr.png" alt="<?php echo $oForm->form_name ?>" title="Form Name:<?php echo $oForm->form_name ?> - Form Key: <?php echo $oForm->form_key ?>" />
                                                                                <img src="https://test.contactus.com
/popup/tpl/<?php echo $oForm->template_desktop_form ?>/scr.png" alt="<?php echo $oForm->form_name ?>" title="Form Name:<?php echo $oForm->form_name ?> - Form Key: <?php echo $oForm->form_key ?>" />
                                                                                <span class="captions">
                                                                                    <p>
                                                                            ...
                                                                            case 'success':
                                                                                foreach ($cUs_json->data as $oForms => $oForm) {
                                                                                    ...
                                                                                    <span class="<?php echo ( (strlen($form_page_key) && $form_page_key == $oForm->form_key) || $form_key == $oForm->form_key)?'default':'tpl'?> item template-<?php echo $page->ID ; ?>" rel="<?php echo $oForm->form_key ?>">
                                                                                        <img class="tab tab-<?php echo $page->ID ; ?>" src="https://test.contactus.com
/popup/tpl/<?php echo $oForm->template_desktop_tab ?>/scr.png" alt="<?php echo $oForm->form_name ?>" title="Form Name:<?php echo $oForm->form_name ?> - Form Key: <?php echo $oForm->form_key ?>" />
                                                                                        <img src="https://test.contactus.com
/popup/tpl/<?php echo $oForm->template_desktop_form ?>/scr.png" alt="<?php echo $oForm->form_name ?>" title="Form Name:<?php echo $oForm->form_name ?> - Form Key: <?php echo $oForm->form_key ?>" />
                                                                                        <span class="captions">
